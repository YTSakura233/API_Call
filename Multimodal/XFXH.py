...
appid = "YOUR APP ID HERE"  # 填写控制台中获取的 APPID 信息
api_secret = "YOUR API SECRET HERE"  # 填写控制台中获取的 APISecret 信息
api_key = "YOUR API KEY HERE"  # 填写控制台中获取的 APIKey 信息
imagedata = open("PATH", 'rb').read()  # 请在此更改图片路径
